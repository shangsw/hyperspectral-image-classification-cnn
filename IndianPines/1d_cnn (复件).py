...
DATA_FILENAME = ['Indianpines_train_'+str(patch_size.patch_size)+'x'+str(patch_size.patch_size)+'_1d.mat',
                 'Indianpines_test_'+str(patch_size.patch_size)+'x'+str(patch_size.patch_size)+'_1d.mat']
