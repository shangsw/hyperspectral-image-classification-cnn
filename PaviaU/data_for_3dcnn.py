...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 24 11:04:09 2018
...
#data[batch, depth, height, width, channels]
TRAIN_PATCH_FINAL = np.reshape(np.array(TRAIN_PATCH),[-1, BAND, PATCH_SIZE, PATCH_SIZE, 1])
TEST_PATCH_FINAL = np.reshape(np.array(TEST_PATCH),[-1, BAND, PATCH_SIZE, PATCH_SIZE, 1])

#Save the patches in segments
#1.Training data
train_dict = {}
file_name = 'Train_'+str(PATCH_SIZE)+'x'+str(PATCH_SIZE)+'_3d.mat'
...
#2.Test data
test_dict = {}
file_name = 'Test_'+str(PATCH_SIZE)+'x'+str(PATCH_SIZE)+'_3d.mat'
