...
DATA_FILENAME = 'PaviaU_test_'+str(patch_size.patch_size)+'x'+str(patch_size.patch_size)+'_1d'

test_data, test_labels=[],[]
for i in range(8):
    test_data_filename = DATA_FILENAME+'_'+str(i)+'_.mat'
...
gt_1dcnn = scipy.io.loadmat(os.path.join(DATA_PATH, 'PaviaU_gt.mat'))['paviaU_gt']
...
#save result
result_1dcnn = {}
file_name = 'PaviaU_1dcnn_result.mat'
